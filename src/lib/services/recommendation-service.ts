...
import { ALL_PRODUCTS, getProductById } from "@/lib/repositories/product-repository";
...
export function getSimilarProducts(product: Product, limit = 4): Recommendation[] {
...
export function getTrending(limit = 4): Recommendation[] {
  return [...ALL_PRODUCTS]
