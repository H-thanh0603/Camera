...
Call log:
  - waiting for getByRole('dialog', { name: 'Giỏ hàng' }).getByRole('link', { name: 'Thanh toán' })
      ...
      - generic [ref=e43]:
        ...
        - generic [ref=e56]:
          ...
          - generic [ref=e99]:
            ...
            - generic [ref=e105]:
              - button "Thêm Vào Giỏ" [active] [ref=e106] [cursor=pointer]:
      ...
      - region "Đánh giá của khách hàng" [ref=e188]:
        - generic [ref=e189]:
          ...
          - generic [ref=e191]:
            ...
            - button "Viết đánh giá" [ref=e200] [cursor=pointer]
        - generic [ref=e201]:
